...
angular.module('well.tradeoff', [])
  ...
  .controller('ThreeTwoCtrl', function ($scope, Aspects, Survey, ThreeTwo, User, $location) {
    ...
    $scope.choose = function (i) {
      ...
      $scope.choices = ThreeTwo.choices()
  ...
  .controller('CompleteCtrl', function ($scope, Aspects, Survey, ThreeTwo, User) {
    $scope.aspects = {
      names: Aspects.names(),
      texts: Aspects.texts(),
      color: Aspects.getColor
    ...
    $scope.responses = Survey.responses()
    $scope.weights = ThreeTwo.weights()
  ...
  .factory('ThreeTwo', function (Aspects, Survey, Tradeoff, User) {
    ...
    choices.record = function (pair, i) {
      ...
      if (i > 6) {
        ...
        this.addMRS(pair[1], pair[0], Tradeoff.values(responses[pair[0]].level, responses[pair[1]].level, choices.positive)[i])
      }
    }
