"use strict";angular.module("well",["ngRoute","well.controllers","well.filters","well.services","well.directives","well.survey","well.tradeoff","well.overlap","well.instruct","well.results","well.instruct","well.admin"]).config(["$routeProvider","$locationProvider",function(t){t.when("/",{templateUrl:"landing.html"}).when("/auth",{templateUrl:"auth.html"}).when("/consent",{templateUrl:"consent.html"}).when("/terms",{templateUrl:"terms.html"}).when("/privacy",{templateUrl:"privacy.html"}).when("/:module/survey",{templateUrl:"survey.html",controller:"SurveyCtrl"}).when("/sur",{templateUrl:"survey.html",controller:"SurveyCtrl"}).when("/transition",{templateUrl:"transition.html",controller:"TransCtrl"}).when("/:module/instructions",{templateUrl:"instructions.html",controller:"InstructCtrl"}).when("/threetwo/abbcca",{templateUrl:"tradeoff.html",controller:"ThreeCtrl"}).when("/threetwo/dbec",{templateUrl:"tradeoff.html",controller:"TwoCtrl"}).when("/overlap/transition",{templateUrl:"transition.html",controller:"TransCtrl"}).when("/overlap/abac",{templateUrl:"tradeoff.html",controller:"AbacCtrl"}).when("/overlap/abc",{templateUrl:"overlap.html",controller:"AbcCtrl"}).when("/fineoverlap/tradeoff",{templateUrl:"fineoverlap.html",controller:"FineCtrl"}).when("/:module/exit",{templateUrl:"exit.html",controller:"ExitCtrl"}).when("/chart",{templateUrl:"chart.html",controller:"ChartCtrl"}).when("/dummy",{templateUrl:"dummy.html",controller:"DummyCtrl"}).when("/test",{templateUrl:"test.html",controller:"TestCtrl"}).when("/admin",{templateUrl:"admin.html",controller:"AdminCtrl"}).when("/anon",{templateUrl:"landing.html",resolve:{login:["User",function(t){return t.loginAnon()}]}}).otherwise({redirectTo:"/"})}]).run(["User","$location","$http",function(t,l){t.isAuthed()||"/admin"===l.path()||l.path("/")}]);
"use strict";angular.module("well.controllers",[]).controller("AppCtrl",["$scope","$rootScope","$timeout","User","$location","Aspects","Survey",function(n,e,o,i,l,s,a){n.aspects={texts:s.texts},e.$on("auth",function(){s.names().then(function(e){return n.aspects.names=e})}),a.getResponses(),n.responses=a.responses,n.user=i,i.isAdmin().then(function(e){n.isAdmin=e}),n.settings={devmode:!1,instruct:!0},n.landing={url:"preamble.html"},n.loc=l,n.login={wrong:!1,placeholder:{email:"Enter your email",password:"Password"},submit:function(){n.login.email?n.login.password?i.login(this.email,this.password).then(function(e){n.login.wrong="in",console.log("Logged in as: ",e.uid),n.landing.url="modules.html"},function(e){n.login.wrong=e.code,"INVALID_EMAIL"===e.code?(n.login.email="",n.login.placeholder.email="Enter a valid email"):"INVALID_PASSWORD"===e.code&&(n.login.password="",n.login.placeholder.password="Enter a valid password"),console.error("Login failed: ",e)}):(n.login.wrong="INVALID_PASSWORD",n.login.placeholder.email="Enter a valid password"):(n.login.wrong="INVALID_EMAIL",n.login.placeholder.email="Enter a valid email")},reset:function(){n.login.email?(n.login.message=n.login.alert="",i.reset(n.login.email).then(function(){n.login.wrong="",n.login.message="We have sent an email with instructions to reset your password"},function(e){n.login.alert=e.message})):(n.login.wrong="INVALID_EMAIL",n.login.placeholder.email="Enter a valid email")}},n.signup={wrong:!1,placeholder:{email:"Enter your email",password:"Password",confirm:"Confirm password"},submit:function(){if(n.signup.email)if(n.signup.password)if(n.signup.password&&n.signup.password&&n.signup.password!==n.signup.confirm)n.signup.wrong="mismatch",n.signup.confirm="";else{i.signup(n.signup.email,n.signup.password).then(function(){o(function(){return n.landing.url="terms.html"})},function(e){console.log(e),n.signup.wrong=e.code,"INVALID_EMAIL"===e.code?(n.signup.email="",n.signup.placeholder.email="Enter a valid email"):"INVALID_PASSWORD"===e.code?(n.signup.password="",n.signup.placeholder.password="Enter a valid password"):"EMAIL_TAKEN"===e.code&&(n.signup.false=!0,alert("The specified email address is already in use.")),console.error("Sign up failed: ",e)})}else n.signup.wrong="INVALID_PASSWORD",n.signup.placeholder.email="Enter a valid password";else n.signup.wrong="INVALID_EMAIL",n.signup.placeholder.email="Enter a valid email"},agree:function(){i.login(n.signup.email,n.signup.password).then(function(e){n.login.wrong="in",console.log("Logged in as: ",e.uid),n.landing.url="modules.html"},function(n){console.log(n)})}},n.terms={agree:function(){"anonymous"!==i.info.provider?(n.terms.agreed=!0,i.login(n.signup.email,n.signup.password).then(function(e){n.login.wrong="in",console.log("Logged in as: ",e.uid),n.landing.url="modules.html"},function(n){console.log(n)})):(n.landing.url="modules.html",n.terms.agreed=!0)}},n.cue={option:null,deltaOne:0,deltaTwo:0}}]).controller("DummyCtrl",["$scope",function(n){var e=["Following your passion","Being acknowledged for your work","Being treated fairly","Having meaningful relationships","Having a sense of purpose"];n.pairs=_.map(e,function(n,o){return[n,e[(o+1)%5]]}),n.levels={},_.each(e,function(e){n.levels[e]=Math.round(35*Math.random()+60)}),n.selections={},console.log(n.pairs,n.levels)}]);
"use strict";angular.module("well.directives",[]).directive("earth",["$window","Aspects",function(t){return{restrict:"EA",scope:{},link:function(e){window.onresize=function(){e.$apply()},e.$watch(function(){return angular.element(t)[0].innerWidth},function(){e.render()});var n=d3.select(".splash");e.render=function(){n.selectAll(".earth *").remove();{var t=window.innerWidth,r=window.innerHeight,a=d3.geo.orthographic().precision(0).scale(500).translate([t/2,r/2]).clipAngle(180),i=d3.select(".splash .earth").append("canvas").attr("width",t).attr("height",r),l=i.node().getContext("2d"),o=d3.geo.path().projection(a).context(l);d3.random.logNormal(1)}_.each(e.responses,function(t){t.rand=20*Math.random()+10}),d3.json("world-110m.json",function(e,n){function i(){a.rotate([.1*c,.1*d,30]),l.clearRect(0,0,t,r),_.each(s,function(t){l.beginPath(),l.strokeStyle=d3.hsl(t.properties.color*c,1,.8).toString(),o(t),l.stroke()})}var c,d=0;window.onscroll=function(){d=(window.pageYOffset||document.scrollTop)-(document.clientTop||0)||0,i()},d3.select("body").on("mousemove",function(){c=d3.mouse(this)[0],i()});var s=(topojson.feature(n,n.objects.land),topojson.feature(n,n.objects.countries).features);_.each(s,function(t){t.properties.color=Math.random()}),i()})}}}}]).directive("range",["$window","$timeout","Aspects",function(t,e){return{restrict:"EA",scope:{level:"="},link:function(n,r){var a=d3.select(r[0]).append("svg").attr("width","100%").attr("height",22);window.onresize=function(){n.$apply()},n.$watch(function(){return angular.element(t)[0].innerWidth},function(){n.render()});var i=null;n.$watch("level",function(t){t!==i&&n.render()}),n.render=function(){function t(){var t=d.extent()[0],r=c.invert(d3.mouse(this)[0]);t=isNaN(r)?t:r,d.extent([t,t]),t&&(t=Math.round(t)),w.style("display","block").attr("d",h(p().set(c(t)))+"Z"),i=t,e(function(){n.level=t})}a.selectAll("*").remove();var l=d3.select(r[0])[0][0].offsetWidth,o=22,c=d3.scale.linear().domain([0,100]).range([6,l-6]).clamp(!0),d=d3.svg.brush().x(c).extent([n.level,n.level]).on("brush",t),s=a.append("g").attr("class","axis");s.call(d3.svg.axis().scale(c).orient("bottom").tickSize(0).tickValues([]));var f=s.select(".domain").attr("transform","translate(0, 10)");f.select(function(){return this.parentNode.appendChild(this.cloneNode(!0))}).attr("class","halo");var u=a.append("g").attr("class","slider").call(d);u.selectAll(".extent,.resize").remove(),u.select(".background").attr("height",o);var p=function(){var t=c(1),e=10;return{set:function(n){return t=n,[{x:t-6,y:e-6},{x:t+6,y:e-6},{x:t+6,y:e+6},{x:t,y:e+10},{x:t-6,y:e+6}]}}},h=d3.svg.line().x(function(t){return t.x}).y(function(t){return t.y}),w=u.append("path").attr("class","handle").attr("d",h(p().set(c(n.level)))+"Z").style("display","none")}}}}]).directive("bar",["$window","Aspects","$filter",function(t,e){return{restrict:"E",scope:{level:"=",name:"=",resize:"="},link:function(n,r){var a=d3.select(r[0]).append("svg").attr("width","100%").attr("height",60),i=a.append("g");window.onresize=function(){n.$apply()},n.$watch("level",function(){n.render()}),n.$watch("name",function(){n.render()}),n.$watch("resize",function(){console.log(n.resize),n.render()}),n.$watch(function(){return angular.element(t)[0].innerWidth},function(){n.render()}),n.render=function(){i.selectAll("*").remove();var t=d3.select(r[0])[0][0].offsetWidth,a=t>0?t:100,l=40,o=d3.scale.linear().domain([0,100]).range([6,a-6]),c=i.append("g").attr("class","axis").attr("transform","translate(0,"+(l-20)+")");c.call(d3.svg.axis().scale(o).orient("bottom").tickSize(0).tickPadding(12)),c.select(".domain").remove();var d=(i.append("rect").attr("class","backbar").attr("x",o(0)).attr("y",4).attr("height",20).attr("width",o(100)-o(0)),i.append("rect").attr("class","barBack").attr("x",o(0)).attr("y",4).attr("height",20).attr("width",o(100)-o(0)).style("fill","#eee"),i.append("rect").attr("class","bar").attr("x",o(0)).attr("y",4).attr("height",20).attr("width",o(n.level)-o(0)).style("fill",e.getColor(n.name,100)),i.append("text").attr("class","text").attr("y",14).attr("dy",".375em").style("fill","#000").style("font-weight","400"),o(n.diff?n.level+n.diff:n.level));n.level&&i.append("line").attr("x1",d).attr("y1",4).attr("x2",d).attr("y2",24).style("stroke","#000")}}}}]).directive("diff",["$window","Aspects","$filter","$timeout","Survey",function(t,e,n,r,a){return{restrict:"E",scope:{level:"=",diff:"=",name:"=",choice:"=",animate:"=",delta:"=",option:"@"},link:function(i,l,o){var c,d=l[0].parentNode.getBoundingClientRect().width,s=d3.select(l[0]).append("svg").attr("width",d).attr("height",120),f=s.append("g").attr("transform","translate(0,10)");window.onresize=function(){i.$apply()},i.$watch("level",function(){i.init()}),i.$watch("diff",function(){i.init()}),i.$watch("name",function(){i.init()});var u=2e3,p=1e3;i.$watch("choice",function(){"one"===o.option&&i.name&&(i.animate="one",r(function(){i.animate="two"},u+p)),i.init()},!0),i.$watch("animate",function(){i.name&&i.animate&&i.animate===o.option&&(i.animate=null,i.init(!0))}),i.$watch(function(){return angular.element(t)[0].innerWidth},function(){i.init(!0)});var h=0,w=0,v=[0,100];i.init=function(t){v?i.render(t):a.range().then(function(e){v=e,i.render(t)})},i.render=function(t){d=l[0].parentNode.getBoundingClientRect().width,s.attr("width",d),f.selectAll("*").remove(),c&&c.remove(),d-=30;var a=28,o=d3.scale.linear().domain(v).range([21,d-6]),m=f.append("g").attr("class","axis").attr("transform","translate(0,"+(a+20)+")");m.call(d3.svg.axis().scale(o).orient("bottom").tickSize(0).tickPadding(12)),m.select(".domain").remove();var g=(f.append("rect").attr("class","backbar").attr("x",o(v[0])).attr("y",a+4).attr("height",20).attr("width",o(v[1])-o(v[0])),f.append("rect").attr("class","barBack").attr("x",o(v[0])).attr("y",a+4).attr("height",20).attr("width",o(v[1])-o(v[0])).style("fill","#eee"),f.append("rect").attr("class","bar").attr("x",o(v[0])).attr("y",a+4).attr("height",20).attr("width",o(i.level)-o(v[0])).style("fill",e.getColor(i.name,100))),y=(f.append("rect").attr("class","diff").attr("y",a+4).attr("height",20).style("fill",e.getColor(i.name,205)),function(t,e,n){return n+=a,"M"+o(t)+" "+Number(n+2)+" L"+Number(o(e)-4)+" "+Number(n+2)+" L"+Number(o(e)-4)+" "+n+" L"+o(e)+" "+Number(n+3)+" L"+Number(o(e)-4)+" "+Number(n+6)+" L"+Number(o(e)-4)+" "+Number(n+4)+" L"+o(t)+" "+Number(n+4)+" Z"}),x=function(t,e,n){return n+=a,"M"+o(t)+" "+Number(n+2)+" L"+Number(o(e)+4)+" "+Number(n+2)+"L"+Number(o(e)+4)+" "+n+" L"+o(e)+" "+Number(n+3)+" L"+Number(o(e)+4)+" "+Number(n+6)+"L"+Number(o(e)+4)+" "+Number(n+4)+" L"+o(t)+" "+Number(n+4)+" Z"},b=(f.append("path").attr("class","arrow").attr("stroke","none").style("fill","#000"),f.append("text").attr("class","text").attr("y",a+14).attr("dy",".375em").style("fill","#000").style("font-weight","400")),$=o(i.diff?i.level+i.diff:i.level);if(i.level&&f.append("line").attr("x1",$).attr("y1",a+4).attr("x2",$).attr("y2",a+24).style("stroke","#000"),t){if(i.diff){var N=o(8)-o(0);c=s.select(function(){return this.appendChild(this.cloneNode(!0))}).attr("class","zoom");var k="clip"+Math.random().toString().replace(".",""),A=c.append("defs").append("clipPath").attr("id",k);A.append("circle").attr("cx",$).attr("cy",a+24).attr("r",N),c.insert("circle","g").attr("cx",$).attr("cy",a+24).attr("r",N).style("fill","#fff"),c.append("circle").attr("cx",$).attr("cy",a+24).attr("r",N).style("fill","none").style("stroke","#000").style("stroke-width","2px");var z=s[0][0].getBoundingClientRect();c.attr("viewBox",$/2+" "+Number(a/2+10)+" "+z.width/2+" "+z.height/2).attr("clip-path","url(#"+k+")").transition().delay(1300).duration(p).attr("viewBox","0 0 "+z.width+" "+z.height).each("end",function(){return c.remove()}),g.style("fill-opacity","0.6").transition().delay(1300).duration(p).style("fill-opacity","1"),d3.transition().delay(300).duration(u).tween("diff",function(){var t=d3.interpolateRound(0,i.diff);return function(e){r(function(){return i.delta=t(e)})}})}if(i.diff>0){w=i.diff,h=o(i.diff)-o(0),s.selectAll(".diff").attr("x",o(i.level)).attr("width",0).transition().delay(300).duration(u).attr("width",h),s.selectAll(".arrow").attr("d",y(i.level,i.level,11)).transition().delay(300).duration(u).attr("d",y(i.level,i.level+i.diff,11)),s.selectAll(".text").text("+"+n("round1")(i.diff));{b.style("width").replace("px","")}s.selectAll(".text").attr("text-anchor","start").attr("x",o(i.level+i.diff)).attr("dx",4)}else i.diff<0?(w=i.diff,h=o(-i.diff)-o(0),s.selectAll(".diff").attr("x",o(i.level)).attr("width",0).style("fill",e.getColor(i.name,40)).transition().delay(300).duration(u).attr("x",o(i.level)-h).attr("width",h),s.selectAll(".arrow").attr("d",x(i.level,i.level,11)).transition().delay(300).duration(u).attr("d",x(i.level,i.level+i.diff,11)),s.selectAll(".text").text(n("round1")(i.diff)),s.selectAll(".text").attr("text-anchor","end").attr("dx",-4).attr("x",o(i.level+i.diff))):w>0?(h=o(w)-o(0),s.selectAll(".diff").attr("x",o(i.level)).attr("width",h).transition().duration(u).attr("width",0)):0>w&&(h=o(-w)-o(0),s.selectAll(".diff").attr("x",o(i.level)-h).attr("width",h).style("fill",e.getColor(i.name,40)).transition().delay(300).duration(u).attr("x",o(i.level)).attr("width",0))}}}}}]).directive("fix",["$window",function(t){return{restrict:"EA",scope:{},link:function(e,n){var r=d3.select(n[0]),a=d3.select(r[0][0].parentNode);window.onresize=function(){e.$apply()},e.$watch(function(){return angular.element(t)[0].innerWidth},function(){e.render()}),e.render=function(){var t=a[0][0].getBoundingClientRect();r.style({position:"fixed",padding:a.style("padding"),top:window.scrollTop?t.top+window.scrollTop+"px":t.top+"px",left:window.scrollLeft?t.left+window.scrollLeft+"px":t.left+"px",width:t.width+"px"})}}}}]).directive("prog",["$window",function(t){return{restrict:"EA",scope:{complete:"="},link:function(e,n){var r=d3.select(n[0]).append("svg").attr("width","100%").attr("height",8);window.onresize=function(){e.$apply()},e.$watch(function(){return angular.element(t)[0].innerWidth},function(){e.render()}),e.$watch("complete",function(){e.render()}),e.render=function(){r.selectAll("*").remove();var t=r[0][0].getBoundingClientRect();r.append("rect").attr("height",8).attr("width",t.width*e.complete).attr("fill","#559")}}}}]).directive("back",["Aspects",function(t){return{restrict:"EA",scope:{name:"="},link:function(e,n){e.$watch("name",function(e){n[0].style.border="1px solid "+t.getColor(e,60)})}}}]);
...
"use strict";angular.module("well.instruct",[]).controller("InstructCtrl",["$scope","Survey","$interval","$timeout","Point","$location",function(t,e,i,n,o,s){e.safeRandomize(),t.instructions={next:function(){switch(s.path().split("/")[1]){case"threetwo":s.path("threetwo/abbcca");break;case"overlap":s.path("overlap/abac");break;case"fineoverlap":s.path("fineoverlap/tradeoff")}}},t.delay=6e3,t.instructions.partZero=!0;var r=function(){switch(t.t/t.delay){case 1:t.instructions.partOne=!0,t.instructions.partZero=!1;break;case 2:t.instructions.partTwo=!0;break;case 3:t.instructions.partOne=!1,t.instructions.partThree=!0;break;case 4:t.instructions.partFour=!0;break;case 5:t.instructions.partThree=!1,t.instructions.partFive=!0,t.instructions.highlightOne=!0,t.instructions.highlightTwo=!0,o.leftRight();break;case 6:t.animating=!1,t.instructions.highlightOne=!1,t.instructions.highlightTwo=!1,t.instructions.done=!0}};t.instructions.run=function(){o.hide(),t.instructions.done=!1,t.instructions.partZero=!0,t.instructions.partOne=!1,t.instructions.partTwo=!1,t.instructions.partThree=!1,t.instructions.partFour=!1,t.instructions.partFive=!1,t.instructions.highlightOne=!1,t.instructions.highlightTwo=!1,t.t=0,t.completed=0,t.animating=!0,i(function(){t.animating&&(t.t+=10,t.completed=t.t/(6*t.delay),r())},10)},t.instructions.run()}]).factory("Point",["$timeout",function(){var t=this,e=this,i=d3.select(".pointer");return this.mouse={x:400,y:400},document.onmousemove=function(e){t.mouse.x=e.clientY,t.mouse.y=e.clientX},this.isWithin=function(t){var e=document.querySelector(t).getBoundingClientRect(),i=document.querySelector(".pointer").getBoundingClientRect();return i.left>e.left&&i.left<e.left+e.width&&i.top>e.top&&i.top<e.top+e.height},this.hide=function(){i.style("display","none")},this.leftRight=function(){var n=document.querySelector(".left").getBoundingClientRect(),o=document.querySelector(".right").getBoundingClientRect();i.style("display","block").style("left",t.mouse.y+"px").style("top",t.mouse.x+"px").transition().duration(2e3).style("left",n.left+n.width/2+"px").style("top",n.top+n.height/2+"px").tween("position",function(){return function(){d3.select(".left").classed("hover",e.isWithin(".left")),d3.select(".right").classed("hover",e.isWithin(".right"))}}).transition().duration(1e3).style("left",o.left+o.width/2+"px").style("top",o.top+o.height/2+"px").tween("position",function(){return function(){d3.select(".left").classed("hover",e.isWithin(".left")),d3.select(".right").classed("hover",e.isWithin(".right"))}}).each("end",function(){d3.select("body").append("svg").attr("width","100%").attr("height","100%").style({position:"fixed",top:0,left:0,"z-index":999,"pointer-events":"none"}).append("circle").attr("cx",o.left+o.width/2).attr("cy",o.top+o.height/2).attr("r",0).style("fill","none").style("stroke","#000").style("stroke-opacity",1).style("stroke-width","2px").transition().duration(1e3).attr("r",100).style("stroke-opacity",0),d3.select(".left").style("opacity",1).transition().duration(1e3).style("opacity",.3)})},this}]);
