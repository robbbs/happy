...
"use strict";angular.module("well.instruct",[]).controller("InstructCtrl",["$scope","$interval","$timeout","Point","$location",function(t,e,i,n,o){t.instructions={next:function(){switch(o.path().split("/")[1]){case"threetwo":o.path("threetwo/abbcca");break;case"overlap":o.path("overlap/abac");break;case"fineoverlap":o.path("fineoverlap/tradeoff")}}};var r=0;e(function(){t.completed=r++/1e3},10),i(function(){t.instructions.partOne=!0},400),i(function(){t.instructions.partTwo=!0},2e3),i(function(){t.instructions.partOne=!1,t.instructions.partThree=!0},4e3),i(function(){t.instructions.partFour=!0},6e3),i(function(){t.instructions.partThree=!1,t.instructions.partFive=!0},8e3);var r=0;i(function(){t.instructions.highlightOne=!0,t.instructions.highlightTwo=!0,n.leftRight()},9e3),i(function(){t.instructions.next()},13e3)}]).factory("Point",["$timeout",function(){var t=this,e=this,i=d3.select(".pointer");return this.mouse={x:400,y:400},document.onmousemove=function(e){t.mouse.x=e.clientY,t.mouse.y=e.clientX},this.isWithin=function(t){var e=document.querySelector(t).getBoundingClientRect(),i=document.querySelector(".pointer").getBoundingClientRect();return i.left>e.left&&i.left<e.left+e.width&&i.top>e.top&&i.top<e.top+e.height},this.leftRight=function(){var n=document.querySelector(".left").getBoundingClientRect(),o=document.querySelector(".right").getBoundingClientRect();i.style("display","block").style("left",t.mouse.y+"px").style("top",t.mouse.x+"px").transition().duration(2e3).style("left",n.left+n.width/2+"px").style("top",n.top+n.height/2+"px").tween("position",function(){return function(){d3.select(".left").classed("hover",e.isWithin(".left")),d3.select(".right").classed("hover",e.isWithin(".right"))}}).transition().duration(1e3).style("left",o.left+o.width/2+"px").style("top",o.top+o.height/2+"px").tween("position",function(){return function(){d3.select(".left").classed("hover",e.isWithin(".left")),d3.select(".right").classed("hover",e.isWithin(".right"))}}).each("end",function(){d3.select("body").append("svg").attr("width","100%").attr("height","100%").style({position:"fixed",top:0,left:0,"z-index":999,"pointer-events":"none"}).append("circle").attr("cx",o.left+o.width/2).attr("cy",o.top+o.height/2).attr("r",0).style("fill","none").style("stroke","#fff").style("stroke-opacity",1).style("stroke-width","2px").transition().duration(1e3).attr("r",100).style("stroke-opacity",0),d3.select(".left").style("opacity",1).transition().duration(1e3).style("opacity",0)})},this}]);
