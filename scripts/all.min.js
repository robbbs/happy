  ...
  .factory('Full', function (Aspects, Survey, User, $firebase) {
    ...
    _.each(comparators, function (a) {
      _.each(comparators, function (b) {
        ...
        if (a !== b && !_.contains(paired, s)) pairs.push(p)
        paired.push(s)
      })
    })
    ...
    var bestValues = function (max_a, max_b, d_a, d_b) {
      console.log(max_a, max_b, d_a, d_b)
    ...
    var methods = {
      ...
      choice: function (p, a, b, d_a, d_b) {
        ...
        var max_a = 100 - responses[a].level,
          max_b = 100 - responses[b].level,
          minmax = Math.min(max_a, max_b)

        if (!p) {
          d_a = d_b = 4 > minmax ? minmax : 4
          return [
            {
              name: a,
              level: responses[a].level,
            ...
            return [
              {
                name: a,
                level: responses[a].level,
                diff: bestValues(max_a, max_b, 1, 4)[0]
              },
              {
                name: b,
                level: responses[b].level,
                diff: bestValues(max_a, max_b, 1, 4)[1]
              }
            ]
          } else if (a_b === .25) {
            return [
              {
                name: a,
                level: responses[a].level,
                diff: bestValues(max_a, max_b, 1, 8)[0]
              },
              {
                name: b,
                level: responses[b].level,
                diff: bestValues(max_a, max_b, 1, 8)[1]
              }
            ]
          } else if (a_b === 4) {
            return [
              {
                name: a,
                level: responses[a].level,
                diff: bestValues(max_a, max_b, 4, 2)[0]
              },
              {
                name: b,
                level: responses[b].level,
                diff: bestValues(max_a, max_b, 4, 2)[1]
              }
            ]
          }
        } else if (p === b) {
            ...
            return [
              {
                name: a,
                level: responses[a].level,
                diff: bestValues(max_a, max_b, 4, 1)[0]
              },
              {
                name: b,
                level: responses[b].level,
                diff: bestValues(max_a, max_b, 4, 1)[1]
              }
            ]
          } else if (a_b === .25) {
            return [
              {
                name: a,
                level: responses[a].level,
                diff: bestValues(max_a, max_b, 2, 4)[0]
              },
              {
                name: b,
                level: responses[b].level,
                diff: bestValues(max_a, max_b, 2, 4)[1]
              }
            ]
          } else if (a_b === 4) {
            return [
              {
                name: a,
                level: responses[a].level,
                diff: bestValues(max_a, max_b, 8, 1)[0]
              },
              {
                name: b,
                level: responses[b].level,
                diff: bestValues(max_a, max_b, 8, 1)[1]
              }
            ]
          }
        }
