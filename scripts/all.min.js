...
"use strict";angular.module("well.instruct",[]).controller("InstructorCtrl",["$scope","Survey","$location",function(t,e,i){e.safeRandomize(),t.instructions={step:0,next:function(){return t.instructions.step++},prev:function(){return t.instructions.step--},repeat:function(){return t.instructions.step=t.instructions.choice=0},understood:function(){switch(i.path().split("/")[1]){case"threetwo":i.path("threetwo/abbcca");break;case"overlap":i.path("overlap/abac");break;case"fineoverlap":i.path("fineoverlap/tradeoff")}}}}]).controller("InstructCtrl",["$scope","Survey","$interval","$timeout","Point","$location",function(t,e,i,n,o,s){e.safeRandomize(),t.instructions={next:function(){switch(s.path().split("/")[1]){case"threetwo":s.path("threetwo/abbcca");break;case"overlap":s.path("overlap/abac");break;case"fineoverlap":s.path("fineoverlap/tradeoff")}}},t.delay=6e3,t.instructions.partZero=!0;var r=function(){switch(t.t/t.delay){case 1:t.instructions.partOne=!0,t.instructions.partZero=!1;break;case 2:t.instructions.partTwo=!0,t.instructions.diffOne=4,t.instructions.animOne="one";break;case 3:t.instructions.partOne=!1,t.instructions.partThree=!0;break;case 4:t.instructions.partFour=!0,t.instructions.diffTwo=4,t.instructions.animTwo="one";break;case 5:t.instructions.partThree=!1,t.instructions.partFive=!0,t.instructions.highlightOne=!0,t.instructions.highlightTwo=!0,o.leftRight();break;case 6:t.animating=!1,i.cancel(t.instructions.promise),t.instructions.highlightOne=!1,t.instructions.highlightTwo=!1,t.instructions.done=!0}};t.instructions.run=function(){o.hide(),t.instructions.done=!1,t.instructions.partZero=!0,t.instructions.partOne=!1,t.instructions.partTwo=!1,t.instructions.partThree=!1,t.instructions.partFour=!1,t.instructions.partFive=!1,t.instructions.highlightOne=!1,t.instructions.highlightTwo=!1,t.instructions.diffOne=0,t.instructions.diffTwo=0,t.t=0,t.completed=0,t.animating=!0,t.instructions.promise=i(function(){t.animating&&(t.t+=10,t.completed=t.t/(6*t.delay),r())},10)},t.instructions.run()}]).directive("stepper",function(){return{restrict:"E",scope:{steps:"=",parent:"="},templateUrl:"stepper.html",link:function(t){console.log(t.steps)}}}).factory("Point",["$timeout",function(){var t=this,e=this,i=d3.select(".pointer-hand");return this.mouse={x:400,y:400},document.onmousemove=function(e){t.mouse.x=e.clientY,t.mouse.y=e.clientX},this.isWithin=function(t){var e=document.querySelector(t).getBoundingClientRect(),i=document.querySelector(".pointer").getBoundingClientRect();return i.left>e.left&&i.left<e.left+e.width&&i.top>e.top&&i.top<e.top+e.height},this.hide=function(){i.style("display","none")},this.leftRight=function(){var n=document.querySelector(".left").getBoundingClientRect(),o=document.querySelector(".right").getBoundingClientRect();i.style("display","block").style("left",t.mouse.y+"px").style("top",t.mouse.x+"px").transition().duration(2e3).style("left",n.left+n.width/2+"px").style("top",n.top+n.height/2+"px").tween("position",function(){return function(){d3.select(".left").classed("hover",e.isWithin(".left")),d3.select(".right").classed("hover",e.isWithin(".right"))}}).transition().duration(1e3).style("left",o.left+o.width/2+"px").style("top",o.top+o.height/2+"px").tween("position",function(){return function(){d3.select(".left").classed("hover",e.isWithin(".left")),d3.select(".right").classed("hover",e.isWithin(".right"))}}).each("end",function(){d3.select("body").append("svg").attr("width","100%").attr("height","100%").style({position:"fixed",top:0,left:0,"z-index":999,"pointer-events":"none"}).append("circle").attr("cx",o.left+o.width/2).attr("cy",o.top+o.height/2).attr("r",0).style("fill","none").style("stroke","#000").style("stroke-opacity",1).style("stroke-width","2px").transition().duration(1e3).attr("r",100).style("stroke-opacity",0),d3.select(".left").style("opacity",1).transition().duration(1e3).style("opacity",.3)})},this}]);
