...
angular.module('well.services', [])
  ...
  .factory('Full', function (Aspects, Survey, User, $firebase) {
    ...
    var methods = {
      ...
      weights: function () {
        _.each(aspects, function (a) {
          var w = methods.weight('Health', a)
          weights[a] = Math.sqrt(w[0]*w[1])
        })
        console.log(weights)
        ...
        _.each(aspects, function (a) {
          weights[a] = weights[a] / sum
        })

        console.log(sum, weights, choices)
        if (!choices.length) {
          return false
        } else {
          return weights
...
angular.module('well.controllers', [])
  ...
  .controller('FullCtrl', function ($scope, Full, Aspects, User, $location) {
    $scope.aspects = {
      names: Aspects.names(),
      texts: Aspects.texts(),
  ...
  .controller('CompleteCtrl', function ($scope, Aspects, Full, Survey, User) {
    $scope.aspects = {
      names: Aspects.names(),
      texts: Aspects.texts(),
      color: Aspects.getColor
