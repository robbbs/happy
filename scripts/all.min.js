...
"use strict";angular.module("well.instruct",[]).controller("InstructCtrl",["$scope","$interval","$timeout","Point","$location",function(t,n,e,i,o){t.instructions={next:function(){switch(o.path().split("/")[1]){case"threetwo":o.path("threetwo/abbcca");break;case"overlap":o.path("overlap/abac");break;case"fineoverlap":o.path("fineoverlap/tradeoff")}}};var r=6e3;t.instructions.partZero=!0,t.instructions.run=function(){i.hide(),t.instructions.done=!1,t.instructions.partZero=!0,t.instructions.partOne=!1,t.instructions.partTwo=!1,t.instructions.partThree=!1,t.instructions.partFour=!1,t.instructions.partFive=!1,t.instructions.highlightOne=!1,t.instructions.highlightTwo=!1,e(function(){t.instructions.partOne=!0,t.instructions.partZero=!1},r).then(function(){return e(function(){t.instructions.partTwo=!0},r)}).then(function(){return e(function(){t.instructions.partOne=!1,t.instructions.partThree=!0},r)}).then(function(){return e(function(){t.instructions.partFour=!0},r)}).then(function(){return e(function(){t.instructions.partThree=!1,t.instructions.partFive=!0},r)}).then(function(){return e(function(){t.instructions.highlightOne=!0,t.instructions.highlightTwo=!0,i.leftRight()},r/4)}).then(function(){return e(function(){t.instructions.highlightOne=!1,t.instructions.highlightTwo=!1,t.instructions.done=!0},r)})},t.instructions.run()}]).factory("Point",["$timeout",function(){var t=this,n=this,e=d3.select(".pointer");return this.mouse={x:400,y:400},document.onmousemove=function(n){t.mouse.x=n.clientY,t.mouse.y=n.clientX},this.isWithin=function(t){var n=document.querySelector(t).getBoundingClientRect(),e=document.querySelector(".pointer").getBoundingClientRect();return e.left>n.left&&e.left<n.left+n.width&&e.top>n.top&&e.top<n.top+n.height},this.hide=function(){e.style("display","none")},this.leftRight=function(){var i=document.querySelector(".left").getBoundingClientRect(),o=document.querySelector(".right").getBoundingClientRect();e.style("display","block").style("left",t.mouse.y+"px").style("top",t.mouse.x+"px").transition().duration(2e3).style("left",i.left+i.width/2+"px").style("top",i.top+i.height/2+"px").tween("position",function(){return function(){d3.select(".left").classed("hover",n.isWithin(".left")),d3.select(".right").classed("hover",n.isWithin(".right"))}}).transition().duration(1e3).style("left",o.left+o.width/2+"px").style("top",o.top+o.height/2+"px").tween("position",function(){return function(){d3.select(".left").classed("hover",n.isWithin(".left")),d3.select(".right").classed("hover",n.isWithin(".right"))}}).each("end",function(){d3.select("body").append("svg").attr("width","100%").attr("height","100%").style({position:"fixed",top:0,left:0,"z-index":999,"pointer-events":"none"}).append("circle").attr("cx",o.left+o.width/2).attr("cy",o.top+o.height/2).attr("r",0).style("fill","none").style("stroke","#fff").style("stroke-opacity",1).style("stroke-width","2px").transition().duration(1e3).attr("r",100).style("stroke-opacity",0),d3.select(".left").style("opacity",1).transition().duration(1e3).style("opacity",.3)})},this}]);
