...
angular.module('well.controllers', [])
  ...
  .controller('mrt', function ($scope) {
    ...
    $scope.$watch('mrt', function () {
      ...
      $scope.mrt.b.diff = $scope.mrt.a.change < 0 ? Math.pow($scope.mrt.a.change, 2) : -Math.pow($scope.mrt.a.change, 2)
    }, true)
  })
/* Filters */
