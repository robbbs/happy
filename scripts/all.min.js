    ...
    return {
      ...
      link: function (scope, element, attrs) {
        ...
        var multi = function () {
          ...
          var y = d3.scale.linear()
              .rangeRound([height - ((varNames.length ) * (varNames.length - 1) * 2.5) - 30, 0]);
          ...
          var area = d3.svg.area()
              ...
              .x(function (d) { return x(d.label) })
              .y0(function (d) { return y(d.y0) + varNames.indexOf(d.name) * 10 })
              .y1(function (d) { return y(d.y0 + d.y) + varNames.indexOf(d.name) * 10 });
          ...
          svg.selectAll().data(seriesArr)
            .enter().append('text')
              ...
              .attr('x', function (d) { return x(d.values[0].label) })
              .attr('dx', -10)
              .attr('y', function (d) { return y(d.values[0].y0 + (d.values[0].y / 2) ) + varNames.indexOf(d.name) * 10  })
          ...
          selection.append('rect')
            ...
            .attr('y', function (d) { return y(d.values[0].y0 + d.values[0].y) + varNames.indexOf(d.name) * 10 })
          ...
          selection.append('rect')
            ...
            .attr('y', function (d) { return y(d.values[d.values.length - 1].y0 + d.values[d.values.length - 1].y) + varNames.indexOf(d.name) * 10  })
            .attr('width', 40)
          ...
          values.selectAll('text').
            ...
            .enter().append('text')
              ...
              .attr('y', function (d) { return y(d.y0 + (d.y / 2)) + varNames.indexOf(d.name) * 10  })
              .attr('dx', 5)
              .attr('dy', '.5em')
          ...
          var sums = svg.selectAll()
            ...
            .enter().append('text')
              ...
              .attr('dx', 5)
              // .attr('text-anchor', function (d) { 
              //   if (d.date === dates[0]) return 'end'
              //   else if (d.date === dates[dates.length - 1]) return 'start'
              //   else return 'middle'
              // })
              // .attr('dx', function (d) {
              //   if (d.date === dates[0]) return -5
              //   else if (d.date === dates[dates.length - 1]) return 5
              //   else return 0             
              // })
              .attr('dy', '-1.25em')
              .style('font-weight', 'bold')
